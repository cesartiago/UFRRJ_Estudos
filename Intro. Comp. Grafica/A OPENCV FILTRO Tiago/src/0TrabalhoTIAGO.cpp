...
int main(int argc, char** argv ) {
	...
	/*--------------------------<<<<<<<<<<<<*/
	cout << "Preencha com os 3 valores do Filtro Bilateral separado por 'ENTER' (15 95 45): \n";
	cin >> bilateral1;
	cin >> bilateral2;
	cin >> bilateral3;
	...
	cout << "Preencha com os valores de Blur separado por 'ENTER' (10 10). Não pode ser zero: \n";
	cin >> blur1;
	cin >> blur2;
	...
	nuseif = destino;
	cout << "Preencha com os valores de GaussianBlur separado por 'ENTER' (3 3 0).\n Só o último pode ser 0. O resto: positivo e ímpar: \n";
	cin >> gaussianB1;
	cin >> gaussianB2;
	...
	cout << "Preencha com os valores de Laplacian separado por 'ENTER': \n";
	//
	//
	nuseif = destino;
	Laplacian_Funcao ();
	...
	cout << "Preencha com os valores de Erode separado por 'ENTER': \n";
	//
	//
	...
	cout << "Preencha com os valores de Dilate separado por 'ENTER': \n";
	//
	//
	...
	Mat destino1;
	cout << "Converter (a original, é mais visível) para RGB? 0:Não 1 etc:Sim \n";
	int cvtRGB;
	cin >> cvtRGB;
	/*
	if (cvtRGB != 0){
	...
	*/
	...
	Mat destino2;
	cout << "Converter para HSV? 0:Não 1 etc:Sim \n";
	int cvtHSV;
	cin >> cvtHSV;
	/*
	if (cvtHSV != 0){
	...
	*/
	...
	cout << "Converter para Tons de Cinza? 0:Não 1:Sim \n";
	int cvtGRAY;
	cin >> cvtGRAY;
	/*
		if (cvtGRAY != 0){
	...
	*/
	...
	imwrite("../imagens/ImagemFinaldoTRABALHO.jpg", destino);
	//SALVA NESSE ENDEREÇO ^
	cout << "Imagem SALVA como: ImagemFinaldoTRABALHO.jpg \n";
...
int sobelF_real (int argc, char** argv)
{
  ...
  */
  ...
  //![load]
	...
	cout << "Preencha com os seguintes valores de Sobel separado por 'ENTER' (Lembre-se: já é usado aqui a conversão COLOR_BGR2GRAY): \n";
...
void Laplacian_Funcao () {
	...
	*/
	...
	cout << "Preencha com os seguintes valores de Laplacian separado por 'ENTER': \n";
